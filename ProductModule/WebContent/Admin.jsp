				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="top-header-left">
							<a href="/StaffModule/LogoutServlet">Log Out</a> <label
					...
					<div class="col-md-8 col-sm-6 col-xs-4">
						<div class="main-menu">
							...
							<ul class="menu">
								...
								<li><a href="#">FAQs</a></li>
								<li><a href="EmpAdmin.jsp?username=<%=username%>&role=<%=role%>">Employee management</a></li>
								<li><a href="Office.html">Office management</a></li>					
								<li><a
									href="paymentpage.jsp?username=<%=username%>&role=<%=role%>">Payment</a></li>
							</ul>
						</div>
						<!-- /.main-menu -->
					</div>
