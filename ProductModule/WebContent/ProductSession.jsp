...
<%
	...
	if ((request.getSession(false).getAttribute("product") == null)) {
%>
...
<body>
    ...
    <![endif]-->
	<%
		String username = (String) session.getAttribute("product");
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="top-header-left">
							<a href="/ProductModule/LogoutServlet">Log Out</a> <label
					...
					<div class="col-md-6 col-sm-7">
						<div class="list-menu">
							<ul>
								...
								<li><a href=ProductOwn.jsp?username=<%=username%>&role=<%=role%>">Manage product records</a></li>
							</ul>
						</div>
						<!-- /.list-menu -->
					</div>
				...
				<div class="col-md-3">
					<div class="product-item-1">
						...
						<div class="product-content">
							...
							<span class="tagline">Partner Name</span> <span class="price">$25.00</span>
							<p>Doloremque quo possimus quas necessitatibus blanditiis
								excepturi. Commodi, sunt asperiores tenetur deleniti labore!</p>
						</div>
						<!-- /.product-content -->
					</div>
					<!-- /.product-item -->
					...
					<div class="product-holder">
						<div class="product-item-2">
							...
							<div class="product-content overlay">
								<h5>
									<a href="#">Kooler Shirt</a>
								</h5>
								<span class="tagline">Partner Name</span> <span class="price">$30.00</span>
								<p>Doloremque quo possimus quas necessitatibus blanditiis
									excepturi. Commodi, sunt tenetur deleniti labore!</p>
							</div>
							<!-- /.product-content -->
						</div>
						<!-- /.product-item-2 -->
					...
					<div class="product-item-3">
						...
						<div class="product-content">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6">
									<div class="full-row">
										<label for="cat">Gender:</label> <select name="cat" id="cat"
											class="postform">
									...
									<div class="full-row">
										<label for="cat1">Size:</label> <select name="cat1" id="cat1"
											class="postform">
											<option value="-1">- Select -</option>
									...
									<div class="full-row">
										<label for="cat2">Color:</label> <select name="cat2" id="cat2"
											class="postform">
											<option value="-1">- Select -</option>
