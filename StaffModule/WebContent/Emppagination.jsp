	...
	<div class="form-popup" id="myForm">
		<form action="EmployeeController" class="form-container" method="post">
			...
			<fieldset>
				...
				First Name: <input type="text" name="fname" /> <br> Extension: <input
					type="text" name="ext" /> <br> Email: <input type="text"
					name="email" /> <br> Office Code: <input type="text"
					name="ocode" /><br>Job Title: <input type="text"
					name="jobt" /> <br> Report to: <input type="text"
					name="repto" /><br> UserName: <input type="text"
					name="uname" />
			</fieldset>
